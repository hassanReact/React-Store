...
const Home = () => {
  ...
  return (
    <div className="bg-white mt-2 px-4 md:16 lg:px-24">
      <div className="container mx-auto py-4 flex flex-col md:flex-row space-x-2">
        <div className="w-full md:w-3/12">
          ...
          <ul className="space-y-4 bg-gray-100 p-3 border">
            {Categories.map((category, index) => (
              <li key={index} className="flex items-center text-md font-medium shadow-sm">
        ...
        <div className="w-full md:w-8/12 mt-8 md:mt-0 h-96 relative">
          <img src={HeroImage} alt="" className="h-full w-full" />
          <div className="absolute top-16 left-8">
            <p className="text-gray-600 mb-4">Code With Hassan</p>
            <h2 className="text-3xl font-bold">Welcome to REACT-SHOP</h2>
